...
import adif.aareforecast.collector.model.aareguru.AareGuruEntry.AareGuruEntryBuilder;
...
public class AareGuruIntegrationService implements InitializingBean {
  ...
  private static final int NUMBER_OF_FORECAST_DAYS = 1; // max=3 (4 days)
  ...
  static {
    ...
    for(int i = 0; i < NUMBER_OF_FORECAST_DAYS; i++) { // 0 = tomorrow
  ...
  @Value("${aareForecastCollector.aareGuruBaseUrl}")
  ...
  private String readV2018Current(String city) {
    String path = UriComponentsBuilder.fromPath("/v2018/current")
        ...
        .queryParam("app", "aare-forecast-ML-trainer")
